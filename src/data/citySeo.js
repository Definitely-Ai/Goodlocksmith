...
export const getCitySchema = (city) => {
    ...
    return { '@context': 'https://schema.org', '@graph': [
        ...
        { '@type': 'Locksmith', '@id': 'https://www.goodlocksmith.com/#business', name: businessFacts.legalName, url: 'https://www.goodlocksmith.com/', telephone: '+1-984-480-5397', email: 'agoodlocksmithllc@gmail.com', image: 'https://www.goodlocksmith.com/logo.png', sameAs: ['https://www.facebook.com/61589951519742/', 'https://www.instagram.com/agoodlocksmithnc/', 'https://nextdoor.com/pages/a-good-locksmith-llc-lillington-nc/', 'https://www.bbb.org/us/nc/lillington/profile/locksmith/a-good-locksmith-llc--0593-90375016', 'https://www.angierchamber.org/business-directory/30583/a-good-locksmith-llc/'], foundingDate: businessFacts.establishedYear, founder: { '@type': 'Person', '@id': 'https://www.goodlocksmith.com/#michael-galdine', name: businessFacts.ownerName, jobTitle: 'Licensed Locksmith and Owner' }, identifier: { '@type': 'PropertyValue', name: 'North Carolina Locksmith License', value: businessFacts.licenseNumber }, address: { '@type': 'PostalAddress', addressLocality: 'Lillington', addressRegion: 'NC', addressCountry: 'US' }, areaServed: { '@type': areaType, name: areaName } },
